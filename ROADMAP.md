...
e2e gated `#[ignore]` pending sub-project D). Sub-project D's foundation
(controlled-env binary + landlock-symlink fix) absorbed into B; D's
remainder is re-introducing the 5 e2e test files. Phase 2 (tau as a
